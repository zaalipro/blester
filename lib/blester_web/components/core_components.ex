defmodule BlesterWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BlesterWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BlesterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BlesterWeb.Gettext, "errors", msg, opts)
    end
  end
