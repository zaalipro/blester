defmodule BlesterWeb.AuthHTML do
  use BlesterWeb, :html
    ...
    <div class="form-container">
      ...
      <form action="/register" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="user[first_name]" id="first_name" required class="form-input" />
        </div>

        <div class="form-group">
          <label for="last_name" class="form-label">Last Name</label>
          <input type="text" name="user[last_name]" id="last_name" required class="form-input" />
        </div>

        <div class="form-group">
          <label for="country" class="form-label">Country</label>
          <input type="text" name="user[country]" id="country" required class="form-input" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="password" name="user[password_confirmation]" id="password_confirmation" required class="form-input" />
        </div>
      ...
      <p class="text-center mt-6">
        Already have an account? <a href="/login" class="text-blue-600 hover:text-blue-800 font-semibold">Log in</a>
      </p>
    </div>
    """
  end
